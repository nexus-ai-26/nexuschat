...
async def test_purge_deletes_only_non_faq_topics_in_target_groups():
    ...
    assert all("speakers" in statement and "faq" in statement for statement in statements)
    assert all("group_one" in statement and "group_two" in statement for statement in statements)
